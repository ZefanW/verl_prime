...
EXPERIMENT_NAME="primepp-stable-${LAM}-q0+-${REF_TYPE}-stage2-negativebeta"
...
python3 -m recipe.prime.main_prime \
    ...
    actor_rollout_ref.model.path=/home/wangzefan/data/verl_prime/checkpoints/deepscaler1.5b/primepp-stable-1.0-q0+-policy-negativebeta/global_step_128/actor/huggingface \
    ...
    reward_model.model.path=/home/wangzefan/data/verl_prime/checkpoints/deepscaler1.5b/primepp-stable-1.0-q0+-policy-negativebeta/global_step_128/reward/huggingface \
