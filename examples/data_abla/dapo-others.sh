...
DAPO_EURUS=/home/wangzefan/dataset/dataset/prime-rl-math-wo-prompt/dapo_eurus.parquet
DAPO_SYNTHETIC=/home/wangzefan/dataset/dataset/prime-rl-math-wo-prompt/dapo_synthetic.parquet
...
python3 -m recipe.prime.main_prime \
    ...
    actor_rollout_ref.model.path=$CKPT/actor/huggingface \
    ...
    reward_model.model.path=$CKPT/reward/huggingface \
